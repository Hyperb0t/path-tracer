...
//            }
    ...
    public void initEmbree() {
        for(SceneObject object : sceneObjects) {
            ...
            Pointer geom = null;
            if(faceSize == 3) {
                System.out.println("creating triangle geometry (object " + object.getName() + ")");
                geom = EmbreeNatives.rtcNewGeometry(embreeDevice, Embree.RTC_GEOMETRY_TYPE_TRIANGLE);
            }
            else {
                System.out.println("creating quad geometry  (object " + object.getName() + ")");
