...
public class RTCRayHitNonStruct {
    ...
    public static final int GEOM_ID_OFFSET = 18 * 4;
    public static final int NG_X_OFFSET = 12 * 4;
    public static final int NG_Y_OFFSET = 13 * 4;
    public static final int NG_Z_OFFSET = 14 * 4;
    public static final int T_FAR_OFFSET = 8 * 4;
    ...
    public static RTCRayHitNonStruct fromBytes(byte[] bytes) {
    ...
    public static RTCRayHitNonStruct fromBytes(ByteBuffer b) {
        RTCRayHitNonStruct r = new RTCRayHitNonStruct();
        r.setOrg_x(b.getFloat());
        r.setOrg_y(b.getFloat());
        r.setOrg_z(b.getFloat());
    ...
    public static RTCRayHitNonStruct fromBytes3(ByteBuffer b) {
        RTCRayHitNonStruct r = new RTCRayHitNonStruct();
        b.order(ByteOrder.LITTLE_ENDIAN);
        float[] farr = new float[b.capacity() / 4];
    ...
    public static RTCRayHitNonStruct fromBytes2(Bytes bytes) {
        RTCRayHitNonStruct r = new RTCRayHitNonStruct();
        bytes.unsafeReadObject(r, STRUCT_BYTE_SIZE);
        return r;
    }
...
//        if (!super.equals(o)) return false;
        RTCRayHitNonStruct rtcRayHit = (RTCRayHitNonStruct) o;
